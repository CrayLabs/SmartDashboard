...
parameterize_creator = pytest.mark.parametrize(
    ...
    [
        pytest.param(
            "test_dashboard/manifest_files/manifesttest.json",
            "name",
            "my-experiment",
        ),
        pytest.param(
        ...
        pytest.param(
            "test_dashboard/manifest_files/manifesttest.json", "launcher", "local"
        ),
        pytest.param(
            "test_dashboard/manifest_files/manifesttest.json", "not_a_field", ""
        ),
        pytest.param("file_doesnt_exist.json", "name", ""),
        pytest.param(
            "test_dashboard/manifest_files/no_experiment_manifest.json",
            "name",
            "",
        ),
    ],
